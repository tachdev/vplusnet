                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <section class="panel team_account">
                                                <header class="panel-heading"><i class="fa fa-edit"></i>&nbsp;&nbsp;Site Info</header>
                                                <div class="panel-body teamman col-xs-9">
                                                    <form action="<?php echo current_url(); ?>" method="post" role="form">
                                                        <div class="form-group">
                                                            <label for="InputEmail1">Page Title</label>
                                                            <div class="input-group mg-b-md">
                                                                  <span class="input-group-addon"><i class="fa fa-archive"></i></span>
                                                                  <input type="text" name="pagetitle" class="form-control" placeholder="page title" value="<?php echo $site['0']['page_title']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="InputEmail1">Password Email</label>
                                                            <div class="input-group mg-b-md">
                                                                  <span class="input-group-addon"><i class="fa fa-archive"></i></span>
                                                                  <input type="password" name="password" class="form-control" placeholder="insert password Email" value="<?php echo base64_decode($site['0']['password']); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="InputEmail1">Meta Description</label>
                                                            <div class="">                                                                 
                                                                  <textarea name="description" class="form-control" rows="4" maxlength="300" placeholder="meta description 100 word"><?php echo $site['0']['meta_desc']; ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="InputEmail1">Meta Keyword</label>
                                                            <div class="input-group mg-b-md">
                                                                  <span class="input-group-addon"><i class="fa fa-archive"></i></span>
                                                                  <input type="text" name="keyword" class="form-control" placeholder="please insert Meta Keyword" value="<?php echo $site['0']['meta_keyword']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="InputEmail1">Facebook Url Page</label>
                                                            <div class="input-group mg-b-md">
                                                                  <span class="input-group-addon"><i class="fa fa-archive"></i></span>
                                                                  <input type="text" name="facebookurl" class="form-control" placeholder="facebook url:http//:www.facebook.com/yourpage" value="<?php echo $site['0']['facebook_url']; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
