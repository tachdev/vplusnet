        ...
        <section class="layout">            
            ...
            <section class="main-content">
                <div class="content-wrap">
                    ...
                    <section class="panel">
                        <header class="panel-heading"><i class="fa fa-edit"></i>&nbsp;&nbsp;Order Table List</header>
                        <div class="panel-body">
                            <div class="form-group add_team col-lg-8">
                                <form method="post" action="<?php echo base_url(); ?>backoffice/ordermanager/index/s"  id="addTeamForm">
                                    <div class="input-group mg-b-md col-lg-4">
                                        <span class="input-group-addon"><i class="fa fa-search"></i></span>
                                        <input type="text" name="search_string" class="form-control add" placeholder="Input Mobile , Order Id , Firstname" value="">
                                    </div>                                    
                                    <button type="submit" class="btn btn-primary btn-sm">
                                       &nbsp;Search
                                    </button>
                             <a href="<?php echo base_url(); ?>backoffice/ordermanager/" class="btn btn-success btn-sm" style="padding-top: 9px;
                            ...
                            <div class="table-responsive no-border">
                                 ...
                                 <table class="table  table-striped mg-t datatable">
                                    ...
                                    <?php foreach ( $query as $querys ): ?>
                                        ...
                                        <tr>
                                            <td><?php echo $querys['order_id']; ?></td>
                                            <td><?php echo $querys['country']; ?></td>                                                                
                                            <td><?php echo $querys['mobile_number']; ?></td>                                                                            
                                            <td><?php echo $querys['firstname']; ?></td>                                                                            
                                            <td><?php echo $querys['total_price']; ?></td>                                                                            
                                            <td><?php echo $querys['date_create']; ?></td>                                                                            
                                            ...
                                            <td>
                                                <?php 
                                                    ...
                                                    if($querys['status'] == 1){
                                                        ...
                                                        echo "unapprove - ยังไม่ได้ชำระเงิน";

                                                    }elseif($querys['status'] == 2){

                                                        echo "unapprove - รอการตรวจสอบ";
                                                        
                                                    }else{

                                                        echo "Approved - ชำระเงินเรียบร้อยเเล้ว";
                                                    }
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('backoffice/ordermanager/edit/'.$querys['order_id']);?>" class="btn btn-success btn-xs"><i class="fa fa-edit"></i> edit </a> 
                                                <button name="delete_button" data-toggle="modal" data-target=".bs-modal-sm" class="btn btn-danger btn-xs del" value="<?php echo $querys['order_id']; ?>"><i class="fa fa-trash-o"></i> delete</button>
                                            </td>
                                        </tr>
    ...
    <script type="text/javascript"> 
        ...
        $(document).on("click","button.del", function (event) {
            ...
            var id = $(this).val();
            $("#modal_link").attr("href", "<?php echo  base_url();?>backoffice/ordermanager/del/"+id );
